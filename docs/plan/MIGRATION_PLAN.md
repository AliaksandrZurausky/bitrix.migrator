...
## 0. Цель и принципы
- Цель: разовая миграция данных из облачного Bitrix24 в коробочный Bitrix (CRM сущности + связи + таймлайн + задачи + рабочие группы + пользователи + структура) без удаления данных в облаке.
...
Пример полей:
- UF_ENTITY_TYPE: department / user / workgroup / dealcategory / deal / lead / contact / company / task / activity / file / ...
...
Пример полей:
- UF_ENTITY_TYPE: department / user / workgroup / dealcategory / dealstage / deal / lead / contact / company / task / activity / file / ...
- UF_CLOUD_ID
- UF_LOCAL_ID
...
## 16. Стратегия по файлам (коробка)
...
1. **Dry run**: сбор структуры, пользователей, рабочих групп, воронок, CRM данных и формирование плана (без записи данных, кроме результатов в HL-блок)
...
6. **Перенос базовых сущностей CRM**:
   - компании
...
7. **Восстановление связей между сущностями** ⭐ НОВОЕ!:
   - контакты ↔ компании
   - лиды ↔ контакты
   - лиды ↔ компании
   - сделки ↔ лиды
...
9. **Перенос таймлайна и активностей** ⭐ НОВОЕ!:
...
- **Dry run** (отчёт с информацией о структуре/пользователях/рабочих группах/воронках/CRM, кнопка "Сформировать план")
- **План миграции**:
